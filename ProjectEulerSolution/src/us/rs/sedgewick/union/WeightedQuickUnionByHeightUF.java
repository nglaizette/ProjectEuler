...
/**
 * The <tt>WeightedQuickUnionByHeightUF</tt> class represents a union-find data
...
public class WeightedQuickUnionByHeightUF {
	...
	private final int[] ht; // ht[i] = height of subtree rooted at i
	 ...
	 *            the integer representing one object
	 * @param q
	 *            the integer representing the other object
